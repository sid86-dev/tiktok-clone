...
const Upload = () => {
    ...
    const uploadVideo = async (e: any) => {
        ...
        if (fileTypes.includes(selectedFile.type)) {
            ...
            client.assets
                ...
                .then((data) => {
                    console.log('videoUploaded Success')
                    setVideoAsset(data);
                    setIsLoading(false);
                });
        } else {
    ...
    return (
        <div className='flex w-full h-full absolute left-0 top-[60px] pt-10 mb-10 lg:pt-5 bg-[#F8F8F8] justify-center'>
            <div className='bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6 w-[60%]'>
                ...
                <div className='flex flex-col gap-3 pb-10'>
                    ...
                    <input
                        ...
                        className="rounded outline-none text-md border-gray-200 p-2 border-2"
                    />
                    <label className='text-md font-medium'>Choose a Category</label>
                    <select onChange={(e) => setCategory(e.target.value)} className="border-2 capitalize lg:p-4 outline-none border-gray-200 text-md p-2 rounded cursor-pointer">
                        {topics.map((topic) => (
                    ...
                    <div className='flex gap-6 mt-10'>
                        ...
                        <button onClick={handlePost} type="button" className='bg-[#F51997] text-white font-medium p-2 rounded w-28 lg:w-44 outline-none'>Post</button>
                    </div>
                </div>
